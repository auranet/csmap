/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.1501  2002/11/21 21:08:24  nto
		...
		Last Revision:	Revision 10.901  2002/01/30 00:58:17  nto
		Last Revision:	Added the general form of this projection, which we call the Oblique Cylindrical.  I believe it's conformal.
		...
		Last Revision:	Revision 10.2  2000/02/11 06:14:41  nto
		Last Revision:	Corrected the calculation of the cosine of the conformal shepere latitude.  Never really knew it was wrong, as we only used it to adjust for more than 90 degrees from the central meridian.
		Last Revision:	Revision 10.1  2000/01/31 00:06:06  nto
		Last Revision:	PCLint clean up.  Fixed potential problem at the poles,
		Last Revision:	Revision 10.0  1999/10/05 18:27:18  nto
		Last Revision:	Revision 9.99  1999/10/05 17:36:29  nto
		Last Revision:	Revision 1.2  1999/09/05 20:44:36  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_swiss.c#3 $"};
#endif
