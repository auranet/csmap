/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.1501  2002/10/13 00:28:41  nto
		...
		Last Revision:	Revision 1.1  2002/02/19 05:44:13  nto
		Last Revision:	Initial Revision

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_osgm91.c#5 $"};
#endif
...
int CScalcOsgm91 (struct cs_Osgm91_ *__This,double *geoidHgt,const double etrs89 [2])
{
	...
	recNbr = (long)(xy [1] / 2000.0);
	eleNbr = (long)(xy [0] / 2000.0) - 50;
