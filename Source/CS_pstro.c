/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.302  2000/09/12 21:06:51  nto
		Last Revision:	Corrected the checking of the standard parallel.
		Last Revision:	Revision 10.301  2000/07/15 22:55:56  nto
		Last Revision:	Added a new variation which accepts a standard circle, rather than a scale reduction factor.
		Last Revision:	Revision 10.300  2000/04/04 23:18:30  nto
		Last Revision:	Revision 10.200  2000/03/02 18:51:21  nto
		Last Revision:	Revision 10.1  2000/01/31 00:01:59  nto
		...
		Last Revision:	Revision 1.2  1999/09/05 19:52:34  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_pstro.c#4 $"};
#endif
...
int EXP_LVL9 CSpstroQ (	Const struct cs_Csdef_ *cs_def,unsigned short prj_code,int err_list [],int list_sz)
{
	...
	if (cs_def->org_lat != cs_K90 && cs_def->org_lat != cs_Km90)	/*lint !e777 */
	{
