/******************************************************************************
	...
	*********************************************************************  
			 ...
			 File Name: $RCSfile: CS_sstro.c $
		   Description:
			   Purpose:

		Revision Level:	$Revision: #4 $
		 Check In Date:	$Date: 2005/12/06 $

		Last Revision:	$Log: CS_sstro.c $
		...
		Last Revision:	Revision 10.301  2000/09/12 21:08:20  nto
		Last Revision:	Fixed cut & paste error in the extent calculation.
		Last Revision:	Revision 10.300  2000/04/04 23:18:30  nto
		Last Revision:	Revision 10.200  2000/03/02 18:51:22  nto
		Last Revision:	Revision 10.1  2000/01/31 00:04:06  nto
		...
		Last Revision:	Revision 1.2  1999/09/05 20:38:10  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_sstro.c#4 $"};
#endif
