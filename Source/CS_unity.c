/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.601  2001/01/25 00:24:51  nto
		Last Revision:	Updated protection system code to be compatible with the new MSI protection system.
		...
		Last Revision:	Revision 10.1  2000/01/31 00:08:01  nto
		...
		Last Revision:	Revision 1.2  1999/09/06 16:24:28  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_unity.c#3 $"};
#endif
