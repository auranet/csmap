/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.501  2000/12/11 05:27:09  nto
		Last Revision:	Adjusted the result when in protected demo mode.
		...
		Last Revision:	Revision 10.3  2000/02/14 07:02:49  nto
		Last Revision:	Added the CS_cs3ll and CS_ll3cs functions.
		Last Revision:	Revision 10.2  2000/01/30 23:47:11  nto
		...
		Last Revision:	Revision 1.2  1999/09/06 19:13:58  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_hpApi.c#3 $"};
#endif
