/******************************************************************************
	...
	*********************************************************************  
			 ...
			 File Name: $Source: C:/Development/NewCsMap/rcs/CSdatumCatalog.c $
			 Full Name:	Datum Catalog Object
		   Description:
			   Purpose:	Encapsulates the functionality associated with a
						Datum File Catalog.

		Revision Level:	$Revision: #3 $
				  Date:	$Date: 2005/07/26 $

		 Last Revision:	$Log: CSdatumCatalog.c $
		 ...
		 Last Revision:	Revision 10.1502  2002/11/06 23:57:50  nto
		 Last Revision:	Major changes to support the new gdcEditor.
		 ...
		 Last Revision:	Revision 10.601  2001/01/25 04:06:25  nto
		 Last Revision:	Fixed a bug in the relative directory referencing of the gdc files.
		 Last Revision:	Revision 10.600  2000/12/11 06:39:36  nto
		 Last Revision:	Release 10.06
		 Last Revision:	Revision 10.501  2000/12/04 18:05:38  nto
		 Last Revision:	Added support for ..\Something reference in a Geodetic Data Catalog file.
		 ...
		 Last Revision:	Revision 10.201  2000/04/03 21:45:18  nto
		 Last Revision:	Fixed to properly trim trailing white space after removing a inline comment.
		 Last Revision:	Revision 10.200  2000/03/02 18:51:11  nto
		 Last Revision:	Revision 1.3  2000/02/14 07:01:21  nto
