/******************************************************************************
	...
	*********************************************************************  
			 ...
			 File Name: $RCSfile: CS_ekrt6.c $
		   Description:
			   Purpose:

		Revision Level:	$Revision: #4 $
		 Check In Date:	$Date: 2005/07/28 $

		Last Revision:	$Log: CS_ekrt6.c $
		...
		Last Revision:	Revision 10.1  2000/01/30 23:34:54  nto
		...
		Last Revision:	Revision 1.2  1999/09/04 03:48:52  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_ekrt6.c#4 $"};
#endif
