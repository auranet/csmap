/******************************************************************************
	...
	*********************************************************************  
			 ...
			 File Name: $RCSfile: CS_geoid99.c $
		   Description:
			   Purpose:
		...
		Last Revision:	$Log: CS_geoid99.c $
		...
		Last Revision:	Revision 11.701  2004/01/13 20:43:58  nto
		Last Revision:	Added support for geoid data file with big endian byte order.
		...
		Last Revision:	Revision 10.1501  2002/11/21 20:35:23  nto
		Last Revision:	Lint clean up.
		Last Revision:	Revision 10.1500  2002/09/22 00:01:20  nto
		Last Revision:	Official Release:= 10.15
		Last Revision:	Revision 10.1400  2002/08/09 18:14:22  nto
		Last Revision:	Revision 10.1201  2002/07/23 04:09:28  nto
		Last Revision:	Fixed an unreported problem dealing with the edge effects.
...
#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_geoid99.c#4 $"};
#endif
