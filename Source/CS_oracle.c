...
struct csOracleNbrMap_ csOracleNbrMap [] =
{
	...
	{     4211L,  4211L, "DJAKRTA.LL",                 "Batavia",                                                          1 },	// Batavia
	...
	{     4232L,  4232L, "OMAN.LL",                    "Fahud",                                                            1 },	// Fahud
	...
	{     4258L,  4258L, "LL-ETRF89",                  "ETRS89",                                                           1 },	// ETRS89
	...
	{    26979L, 26979L, "KY83-N",                     "NAD83 / Kentucky North",                                           3 },	// NAD83 / Kentucky North
	...
	{     3034L,  3034L, "ETRF89.Europe/Lambert",      "ETRS89 / ETRS-LCC",                                                0 },	// ETRS89 / ETRS-LCC
	...
	{     3038L,  3038L, "ETRF89.TM26",                "ETRS89 / ETRS-TM26",                                               0 },	// ETRS89 / ETRS-TM26
	{     3039L,  3039L, "ETRF89.TM27",                "ETRS89 / ETRS-TM27",                                               0 },	// ETRS89 / ETRS-TM27
	{     3040L,  3040L, "ETRF89.TM28",                "ETRS89 / ETRS-TM28",                                               0 },	// ETRS89 / ETRS-TM28
	{     3041L,  3041L, "ETRF89.TM29",                "ETRS89 / ETRS-TM29",                                               0 },	// ETRS89 / ETRS-TM29
	{     3042L,  3042L, "ETRF89.TM30",                "ETRS89 / ETRS-TM30",                                               0 },	// ETRS89 / ETRS-TM30
	{     3043L,  3043L, "ETRF89.TM31",                "ETRS89 / ETRS-TM31",                                               0 },	// ETRS89 / ETRS-TM31
	{     3044L,  3044L, "ETRF89.TM32",                "ETRS89 / ETRS-TM32",                                               0 },	// ETRS89 / ETRS-TM32
	{     3045L,  3045L, "ETRF89.TM33",                "ETRS89 / ETRS-TM33",                                               0 },	// ETRS89 / ETRS-TM33
	{     3046L,  3046L, "ETRF89.TM34",                "ETRS89 / ETRS-TM34",                                               0 },	// ETRS89 / ETRS-TM34
	{     3047L,  3047L, "ETRF89.TM35",                "ETRS89 / ETRS-TM35",                                               0 },	// ETRS89 / ETRS-TM35
	{     3048L,  3048L, "ETRF89.TM36",                "ETRS89 / ETRS-TM36",                                               0 },	// ETRS89 / ETRS-TM36
	{     3049L,  3049L, "ETRF89.TM37",                "ETRS89 / ETRS-TM37",                                               0 },	// ETRS89 / ETRS-TM37
	{     3050L,  3050L, "ETRF89.TM38",                "ETRS89 / ETRS-TM38",                                               0 },	// ETRS89 / ETRS-TM38
	{     3051L,  3051L, "ETRF89.TM39",                "ETRS89 / ETRS-TM39",                                               0 },	// ETRS89 / ETRS-TM39
	...
	{    31294L, 31284L, "MGI.M28",                    "MGI / M28",                                                        0 },	// MGI / M28
	{    31295L, 31285L, "MGI.M31",                    "MGI / M31",                                                        0 },	// MGI / M31
	{    31296L, 31286L, "MGI.M34",                    "MGI / M34",                                                        0 },	// MGI / M34
	{    31297L, 31287L, "MGI.Austria",                "MGI / Austria Lambert",                                            0 },	// MGI / Austria Lambert
...
{
	{   6121L,  "Greek-GRS87",              "Greek Geodetic Reference System 1987 (EPSG ID 6121)",                                      0 },	// Greek Geodetic Reference System 1987
	{   6122L,  "ATS77",                    "Average Terrestrial System 1977 (EPSG ID 6122)",                                           1 },	// Average Terrestrial System 1977
	{   6123L,  "Kartasto66",               "Kartasto Koordinaati Jarjestelma 1966 (EPSG ID 6123)",                                     0 },	// Kartastokoordinaattijarjestelma (1966)
	{   6124L,  "RT90",                     "Rikets koordinatsystem 1990 (EPSG ID 6124)",                                               1 },	// Rikets koordinatsystem 1990
	{   6125L,  "Samboja",                  "Samboja (EPSG ID 6125)",                                                                   2 },	// Samboja
	{   6126L,  "Lithuania94",              "Lithuania 1994 (ETRS89) (EPSG ID 6126)",                                                   0 },	// Lithuania 1994 (ETRS89)
	{   6127L,  "Tete",                     "Tete (EPSG ID 6127)",                                                                      0 },	// Tete
	{   6130L,  "Moznet",                   "Moznet (ITRF94) (EPSG ID 6130)",                                                           0 },	// Moznet (ITRF94)
	{   6131L,  "Indian60",                 "Indian 1960 (EPSG ID 6131)",                                                               0 },	// Indian 1960
	{   6132L,  "Final58",                  "Final Datum 1958 (EPSG ID 6132)",                                                          0 },	// Final Datum 1958
	{   6133L,  "Estonia92",                "Estonia 1992 (EPSG ID 6133)",                                                              0 },	// Estonia 1992
	{   6134L,  "PDOSurvey93",              "PDO Survey Datum 1993 (EPSG ID 6134)",                                                     0 },	// PDO Survey Datum 1993
	{   6135L,  "OLDHI",                    "Old Hawaiian (EPSG ID 6135)",                                                              1 },	// Old Hawaiian
	{   6139L,  "PRVI",                     "Puerto Rico (EPSG ID 6139)",                                                               1 },	// Puerto Rico
	{   6140L,  "CSRS",                     "NAD83 Canadian Spatial Reference System (EPSG ID 6140)",                                   1 },	// NAD83 Canadian Spatial Reference System
	{   6141L,  "Israel",                   "Israel (EPSG ID 6141)",                                                                    0 },	// Israel
	{   6142L,  "Locodjo65",                "Locodjo 1965 (EPSG ID 6142)",                                                              0 },	// Locodjo 1965
	{   6143L,  "Abidjan87",                "Abidjan 1987 (EPSG ID 6143)",                                                              0 },	// Abidjan 1987
	{   6144L,  "Kalianpur37",              "Kalianpur 1937 (EPSG ID 6144)",                                                            0 },	// Kalianpur 1937
	{   6145L,  "Kalianpur62",              "Kalianpur 1962 (EPSG ID 6145)",                                                            0 },	// Kalianpur 1962
	{   6146L,  "Kalianpur75",              "Kalianpur 1975 (EPSG ID 6146)",                                                            0 },	// Kalianpur 1975
	{   6147L,  "Hanoi72",                  "Hanoi 1972 (EPSG ID 6147)",                                                                0 },	// Hanoi 1972
	{   6148L,  "Hartebeesthoek94",         "Hartebeesthoek94 (EPSG ID 6148)",                                                          0 },	// Hartebeesthoek94
	{   6149L,  "CH1903",                   "CH1903 (EPSG ID 6149)",                                                                    0 },	// CH1903
	{   6150L,  "CH1903Plus",               "CH1903+ (EPSG ID 6150)",                                                                   0 },	// CH1903+
	{   6151L,  "CHTRF95",                  "Swiss Terrestrial Reference Frame 1995 (EPSG ID 6151)",                                    0 },	// Swiss Terrestrial Reference Frame 1995
	{   6152L,  "HPGN",                     "NAD83 (High Accuracy Regional Network) (EPSG ID 6152)",                                    0 },	// NAD83 (High Accuracy Regional Network)
	{   6153L,  "Rassadiran",               "Rassadiran (EPSG ID 6153)",                                                                0 },	// Rassadiran
	{   6154L,  "Europ50/77",               "European Datum 1950(1977) (EPSG ID 6154)",                                                 0 },	// European Datum 1950(1977)
	{   6155L,  "Dabola81",                 "Dabola 1981 (EPSG ID 6155)",                                                               0 },	// Dabola 1981
	{   6156L,  "S-JTSK",                   "Jednotne Trigonometricke Site Katastralni (EPSG ID 6156)",                                 1 },	// Jednotne Trigonometricke Site Katastralni
	{   6158L,  "NAPARIMA",                 "Naparima 1955 (EPSG ID 6158)",                                                             1 },	// Naparima 1955
	{   6159L,  "EuropLibyan79",            "European Libyan Datum 1979 (EPSG ID 6159)",                                                0 },	// European Libyan Datum 1979
	{   6161L,  "Castillo",                 "Pampa del Castillo (EPSG ID 6161)",                                                        0 },	// Pampa del Castillo
	{   6163L,  "YemenNtl96",               "Yemen National Geodetic Network 1996 (EPSG ID 6163)",                                      0 },	// Yemen National Geodetic Network 1996
	{   6164L,  "SouthYemen",               "South Yemen (EPSG ID 6164)",                                                               0 },	// South Yemen
	{   6165L,  "Bissau",                   "Bissau (EPSG ID 6165)",                                                                    0 },	// Bissau
	{   6166L,  "Korean95",                 "Korean Datum 1995 (EPSG ID 6166)",                                                         0 },	// Korean Datum 1995
	{   6167L,  "NZGD2000",                 "New Zealand Geodetic Datum 2000 (EPSG ID 6167)",                                           1 },	// New Zealand Geodetic Datum 2000
	{   6168L,  "Accra",                    "Accra (EPSG ID 6168)",                                                                     0 },	// Accra
	{   6169L,  "AmSamoa62",                "American Samoa 1962 (EPSG ID 6169)",                                                       0 },	// American Samoa 1962
	{   6170L,  "GRSSA",                    "Sistema de Referencia Geocentrico para America del Sur (EPSG ID 6170)",                    0 },	// Sistema de Referencia Geocentrico para America del Sur 1995
	{   6171L,  "RGF93",                    "Reseau Geodesique Francais 1993 (EPSG ID 6171)",                                           1 },	// Reseau Geodesique Francais 1993
	{   6172L,  "PosGAr",                   "Posiciones Geodesicas Argentinas (EPSG ID 6172)",                                          2 },	// Posiciones Geodesicas Argentinas
	{   6173L,  "IRENET95",                 "IRENET95 (EPSG ID 6173)",                                                                  0 },	// IRENET95
	{   6175L,  "SierraLeone68",            "Sierra Leone 1968 (EPSG ID 6175)",                                                         0 },	// Sierra Leone 1968
	{   6176L,  "Antarctic98",              "Australian Antarctic Datum 1998 (EPSG ID 6176)",                                           0 },	// Australian Antarctic Datum 1998
	{   6178L,  "Pulkovo42/83",             "Pulkovo 1942/83 (EPSG ID 6178)",                                                           0 },	// Pulkovo 1942/83
	{   6179L,  "Pulkovo42/58",             "Pulkovo 1942/58 (EPSG ID 6179)",                                                           0 },	// Pulkovo 1942/58
	{   6180L,  "Estonia97",                "Estonia 1997 (EPSG ID 6180)",                                                              0 },	// Estonia 1997
	{   6181L,  "Luxembourg30",             "Luxembourg 1930 (EPSG ID 6181)",                                                           0 },	// Luxembourg 1930
	{   6182L,  "OBSRV66",                  "Azores Occidental Islands 1939 (EPSG ID 6182)",                                            1 },	// Azores Occidental Islands 1939
	{   6183L,  "AZORES",                   "Azores Central Islands 1948 (EPSG ID 6183)",                                               1 },	// Azores Central Islands 1948
	{   6184L,  "SAOBRAZ",                  "Azores Oriental Islands 1940 (EPSG ID 6184)",                                              1 },	// Azores Oriental Islands 1940
	{   6188L,  "OSNI52",                   "OSNI 1952 (EPSG ID 6188)",                                                                 0 },	// OSNI 1952
	{   6189L,  "REGVEN",                   "Red Geodesica Venezolana (EPSG ID 6189)",                                                  0 },	// Red Geodesica Venezolana
	{   6190L,  "PGA98",                    "Posiciones Geodesicas Argentinas 1998 (EPSG ID 6190)",                                     0 },	// Posiciones Geodesicas Argentinas 1998
	{   6192L,  "Douala48",                 "Douala 1948 (EPSG ID 6192)",                                                               0 },	// Douala 1948
	{   6193L,  "Manoca62",                 "Manoca 1962 (EPSG ID 6193)",                                                               0 },	// Manoca 1962
	{   6194L,  "Qornoq27",                 "Qornoq 1927 (EPSG ID 6194)",                                                               0 },	// Qornoq 1927
	{   6195L,  "Scoresbysund52",           "Scoresbysund 1952 (EPSG ID 6195)",                                                         0 },	// Scoresbysund 1952
	{   6196L,  "Ammassalik58",             "Ammassalik 1958 (EPSG ID 6196)",                                                           0 },	// Ammassalik 1958
	{   6201L,  "ADINDAN",                  "Adindan (EPSG ID 6201)",                                                                   1 },	// Adindan
	{   6202L,  "AGD66",                    "Australian Geodetic Datum 1966 (EPSG ID 6202)",                                            1 },	// Australian Geodetic Datum 1966
	{   6203L,  "AGD84",                    "Australian Geodetic Datum 1984 (EPSG ID 6203)",                                            1 },	// Australian Geodetic Datum 1984
	{   6204L,  "AINELABD",                 "Ain el Abd 1970 (EPSG ID 6204)",                                                           1 },	// Ain el Abd 1970
	{   6205L,  "AFGOOYE",                  "Afgooye (EPSG ID 6205)",                                                                   1 },	// Afgooye
	{   6207L,  "Lisbon37",                 "Lisbon 1937 (EPSG ID 6207)",                                                               0 },	// Lisbon 1937
	{   6208L,  "Aratu",                    "Aratu (EPSG ID 6208)",                                                                     0 },	// Aratu
	{   6209L,  "ARC1950",                  "Arc 1950 (EPSG ID 6209)",                                                                  1 },	// Arc 1950
	{   6210L,  "ARC1960",                  "Arc 1960 (EPSG ID 6210)",                                                                  1 },	// Arc 1960
	{   6211L,  "DJAKRTA",                  "Batavia (EPSG ID 6211)",                                                                   1 },	// Batavia
	{   6212L,  "Barbados38",               "Barbados 1938 (EPSG ID 6212)",                                                             0 },	// Barbados 1938
	{   6214L,  "Beijing54",                "Beijing 1954 (EPSG ID 6214)",                                                              1 },	// Beijing 1954
	{   6216L,  "BERMUDA",                  "Bermuda 1957 (EPSG ID 6216)",                                                              1 },	// Bermuda 1957
	{   6218L,  "BOGOTA",                   "Bogota 1975 (EPSG ID 6218)",                                                               1 },	// Bogota 1975
	{   6219L,  "BukitRimpah",              "Bukit Rimpah (EPSG ID 6219)",                                                              0 },	// Bukit Rimpah
	{   6220L,  "Camacupa",                 "Camacupa (EPSG ID 6220)",                                                                  0 },	// Camacupa
	{   6221L,  "CAMPO",                    "Campo Inchauspe (EPSG ID 6221)",                                                           1 },	// Campo Inchauspe
	{   6222L,  "CAPE-1",                   "Cape (EPSG ID 6222)",                                                                      1 },	// Cape
	{   6223L,  "CARTHAGE",                 "Carthage (EPSG ID 6223)",                                                                  1 },	// Carthage
	{   6224L,  "CHAU",                     "Chua (EPSG ID 6224)",                                                                      1 },	// Chua
	{   6225L,  "CORREGO",                  "Corrego Alegre (EPSG ID 6225)",                                                            1 },	// Corrego Alegre
	{   6227L,  "DeirEzZor",                "Deir ez Zor (EPSG ID 6227)",                                                               0 },	// Deir ez Zor
	{   6229L,  "OLD-EGYP",                 "Egypt 1907 (EPSG ID 6229)",                                                                1 },	// Egypt 1907
	{   6230L,  "ED50",                     "European Datum 1950 (EPSG ID 6230)",                                                       1 },	// European Datum 1950
	{   6231L,  "Europ87",                  "European Datum 1987 (EPSG ID 6231)",                                                       0 },	// European Datum 1987
	{   6232L,  "OMAN",                     "Fahud (EPSG ID 6232)",                                                                     1 },	// Fahud
	{   6233L,  "GNDAJIKA",                 "Gandajika 1970 (EPSG ID 6233)",                                                            3 },	// Gandajika 1970
	{   6236L,  "HuTzuShan",                "Hu Tzu Shan (EPSG ID 6236)",                                                               0 },	// Hu Tzu Shan
	{   6237L,  "HD-72",                    "Hungarian Datum 1972 (EPSG ID 6237)",                                                      1 },	// Hungarian Datum 1972
	{   6238L,  "Indonesian74",             "Indonesian Datum 1974 (EPSG ID 6238)",                                                     0 },	// Indonesian Datum 1974
	{   6239L,  "Indian54",                 "Indian 1954 (EPSG ID 6239)",                                                               0 },	// Indian 1954
	{   6240L,  "Indian75",                 "Indian 1975 (EPSG ID 6240)",                                                               0 },	// Indian 1975
	{   6242L,  "Jamaica69",                "Jamaica 1969 (EPSG ID 6242)",                                                              0 },	// Jamaica 1969
	{   6244L,  "KANDWALA",                 "Kandawala (EPSG ID 6244)",                                                                 1 },	// Kandawala
	{   6245L,  "KERTAU48",                 "Kertau (EPSG ID 6245)",                                                                    1 },	// Kertau 1968
	{   6246L,  "KuwaitOilCo",              "Kuwait Oil Company (EPSG ID 6246)",                                                        0 },	// Kuwait Oil Company
	{   6247L,  "LaCanoa",                  "La Canoa (EPSG ID 6247)",                                                                  0 },	// La Canoa
	{   6248L,  "PSAD56",                   "Provisional South American Datum 1956 (EPSG ID 6248)",                                     1 },	// Provisional South American Datum 1956
	{   6250L,  "Leigon",                   "Leigon (EPSG ID 6250)",                                                                    0 },	// Leigon
	{   6251L,  "LIBERIA",                  "Liberia 1964 (EPSG ID 6251)",                                                              1 },	// Liberia 1964
	{   6253L,  "LUZON",                    "Luzon 1911 (EPSG ID 6253)",                                                                1 },	// Luzon 1911
	{   6254L,  "HitoXVIII63",              "Hito XVIII 1963 (EPSG ID 6254)",                                                           0 },	// Hito XVIII 1963
	{   6255L,  "HeratNorth",               "Herat North (EPSG ID 6255)",                                                               0 },	// Herat North
	{   6256L,  "MAHE1971",                 "Mahe 1971 (EPSG ID 6256)",                                                                 1 },	// Mahe 1971
	{   6257L,  "Makassar",                 "Makassar (EPSG ID 6257)",                                                                  0 },	// Makassar
	{   6258L,  "ETRF89",                   "European Terrestrial Reference System 1989 (EPSG ID 6258)",                                1 },	// European Terrestrial Reference System 1989
	{   6259L,  "Malongo87",                "Malongo 1987 (EPSG ID 6259)",                                                              0 },	// Malongo 1987
	{   6260L,  "Manoca",                   "Manoca (EPSG ID 6260)",                                                                    2 },	// Manoca
	{   6261L,  "MERCHICH",                 "Merchich (EPSG ID 6261)",                                                                  1 },	// Merchich
	{   6262L,  "MASSAWA",                  "Massawa (EPSG ID 6262)",                                                                   1 },	// Massawa
	{   6263L,  "MINNA",                    "Minna (EPSG ID 6263)",                                                                     1 },	// Minna
	{   6264L,  "Mhast",                    "Mhast (EPSG ID 6264)",                                                                     2 },	// Mhast
	{   6265L,  "ROME1940",                 "Monte Mario (EPSG ID 6265)",                                                               1 },	// Monte Mario
	{   6266L,  "Mporaloko",                "M'poraloko (EPSG ID 6266)",                                                                0 },	// M'poraloko
	{   6267L,  "NAD27",                    "North American Datum 1927 (EPSG ID 6267)",                                                 1 },	// North American Datum 1927
	{   6268L,  "MICHIGAN",                 "NAD Michigan (EPSG ID 6268)",                                                              1 },	// NAD Michigan
	{   6269L,  "NAD83",                    "North American Datum 1983 (EPSG ID 6269)",                                                 1 },	// North American Datum 1983
	{   6270L,  "NHRWN-O",                  "Nahrwan 1967 (EPSG ID 6270)",                                                              1 },	// Nahrwan 1967
	{   6271L,  "Naparima72",               "Naparima 1972 (EPSG ID 6271)",                                                             0 },	// Naparima 1972
	{   6272L,  "NZGD49",                   "New Zealand Geodetic Datum 1949 (EPSG ID 6272)",                                           1 },	// New Zealand Geodetic Datum 1949
	{   6273L,  "NGO48",                    "NGO 1948 (EPSG ID 6273)",                                                                  0 },	// NGO 1948
	{   6274L,  "Datum73",                  "Datum 73 (EPSG ID 6274)",                                                                  0 },	// Datum 73
	{   6275L,  "NTF",                      "Nouvelle Triangulation Francaise (EPSG ID 6275)",                                          1 },	// Nouvelle Triangulation Francaise
	{   6277L,  "OSGB",                     "OSGB 1936 (EPSG ID 6277)",                                                                 1 },	// OSGB 1936
	{   6281L,  "Palestine23",              "Palestine 1923 (EPSG ID 6281)",                                                            0 },	// Palestine 1923
	{   6282L,  "PointeNoire",              "Congo 1960 Pointe Noire (EPSG ID 6282)",                                                   0 },	// Congo 1960 Pointe Noire
	{   6283L,  "GDA94",                    "Geocentric Datum of Australia 1994 (EPSG ID 6283)",                                        1 },	// Geocentric Datum of Australia 1994
	{   6284L,  "Pulkovo1942",              "Pulkovo 1942 (EPSG ID 6284)",                                                              1 },	// Pulkovo 1942
	{   6285L,  "Qatar74",                  "Qatar 1974 (EPSG ID 6285)",                                                                0 },	// Qatar 1974
	{   6286L,  "QATAR",                    "Qatar 1948 (EPSG ID 6286)",                                                                1 },	// Qatar 1948
	{   6287L,  "QORNOQ",                   "Qornoq (EPSG ID 6287)",                                                                    3 },	// Qornoq
	{   6289L,  "Amersfoort",               "Amersfoort (EPSG ID 6289)",                                                                1 },	// Amersfoort
	{   6291L,  "SAD69",                    "South American Datum 1969 (EPSG ID 6291)",                                                 2 },	// South American Datum 1969
	{   6292L,  "SAPPER",                   "Sapper Hill 1943 (EPSG ID 6292)",                                                          1 },	// Sapper Hill 1943
	{   6293L,  "SCHWARZK",                 "Schwarzeck (EPSG ID 6293)",                                                                1 },	// Schwarzeck
	{   6294L,  "Segora",                   "Segora (EPSG ID 6294)",                                                                    2 },	// Segora
	{   6297L,  "Tananarive25",             "Tananarive 1925 (EPSG ID 6297)",                                                           0 },	// Tananarive 1925
	{   6298L,  "TMBLI-B",                  "Timbalai 1948 (EPSG ID 6298)",                                                             1 },	// Timbalai 1948
	{   6299L,  "TM65",                     "TM65 (EPSG ID 6299)",                                                                      0 },	// TM65
	{   6301L,  "TOKYO",                    "Tokyo (EPSG ID 6301)",                                                                     1 },	// Tokyo
	{   6302L,  "Trinidad03",               "Trinidad 1903 (EPSG ID 6302)",                                                             0 },	// Trinidad 1903
	{   6304L,  "Voirol1875",               "Voirol 1875 (EPSG ID 6304)",                                                               0 },	// Voirol 1875
	{   6307L,  "NordSahara59",             "Nord Sahara 1959 (EPSG ID 6307)",                                                          0 },	// Nord Sahara 1959
	{   6309L,  "Yacare",                   "Yacare (EPSG ID 6309)",                                                                    0 },	// Yacare
	{   6311L,  "ZANDERIJ",                 "Zanderij (EPSG ID 6311)",                                                                  1 },	// Zanderij
	{   6312L,  "MGI",                      "Militar-Geographische Institut (EPSG ID 6312)",                                            0 },	// Militar-Geographische Institut
	{   6313L,  "Belge72",                  "Reseau National Belge 1972 (EPSG ID 6313)",                                                0 },	// Reseau National Belge 1972
	{   6314L,  "DHDN",                     "Deutsches Hauptdreiecksnetz (EPSG ID 6314)",                                               0 },	// Deutsches Hauptdreiecksnetz
	{   6315L,  "Conakry05",                "Conakry 1905 (EPSG ID 6315)",                                                              0 },	// Conakry 1905
	{   6316L,  "DealulPiscului33",         "Dealul Piscului 1933 (EPSG ID 6316)",                                                      0 },	// Dealul Piscului 1933
	{   6317L,  "DealulPiscului70",         "Dealul Piscului 1970 (EPSG ID 6317)",                                                      0 },	// Dealul Piscului 1970
	{   6318L,  "NtlGeodeticNet",           "National Geodetic Network (EPSG ID 6318)",                                                 0 },	// National Geodetic Network
	{   6319L,  "KuwaitUtility",            "Kuwait Utility (EPSG ID 6319)",                                                            0 },	// Kuwait Utility
	{   6322L,  "WGS72",                    "World Geodetic System 1972 (EPSG ID 6322)",                                                1 },	// World Geodetic System 1972
	{   6324L,  "WGS72-TBE",                "WGS 72 Transit Broadcast Ephemeris (EPSG ID 6324)",                                        0 },	// WGS 72 Transit Broadcast Ephemeris
	{   6326L,  "WGS84",                    "World Geodetic System 1984 (EPSG ID 6326)",                                                1 },	// World Geodetic System 1984
	{   6601L,  "Antigua43",                "Antigua 1943 (EPSG ID 6601)",                                                              0 },	// Antigua 1943
	{   6602L,  "Dominica45",               "Dominica 1945 (EPSG ID 6602)",                                                             0 },	// Dominica 1945
	{   6603L,  "Grenada53",                "Grenada 1953 (EPSG ID 6603)",                                                              0 },	// Grenada 1953
	{   6604L,  "Montserrat58",             "Montserrat 1958 (EPSG ID 6604)",                                                           0 },	// Montserrat 1958
	{   6605L,  "StKitts55",                "St. Kitts 1955 (EPSG ID 6605)",                                                            0 },	// St. Kitts 1955
	{   6606L,  "StLucia55",                "St. Lucia 1955 (EPSG ID 6606)",                                                            0 },	// St. Lucia 1955
	{   6607L,  "StVincent45",              "St. Vincent 1945 (EPSG ID 6607)",                                                          0 },	// St. Vincent 1945
	{   6610L,  "Xian80",                   "Xian 1980 (EPSG ID 6610)",                                                                 1 },	// Xian 1980
	{   6611L,  "HongKong80",               "Hong Kong 1980 (EPSG ID 6611)",                                                            0 },	// Hong Kong 1980
	{   6612L,  "JGD2000",                  "Japanese Geodetic Datum 2000 (EPSG ID 6612)",                                              0 },	// Japanese Geodetic Datum 2000
	{   6613L,  "Segara",                   "Gunung Segara (EPSG ID 6613)",                                                             0 },	// Gunung Segara
	{   6614L,  "QatarNtl95",               "Qatar National Datum 1995 (EPSG ID 6614)",                                                 0 },	// Qatar National Datum 1995
	{   6615L,  "MADEIRA",                  "Porto Santo 1936 (EPSG ID 6615)",                                                          1 },	// Porto Santo 1936
	{   6616L,  "SelvagemGrande",           "Selvagem Grande (EPSG ID 6616)",                                                           0 },	// Selvagem Grande
	{   6618L,  "SA1969",                   "South American Datum 1969 (EPSG ID 6618)",                                                 1 },	// South American Datum 1969
	{   6619L,  "SWEREF99",                 "SWEREF99 (EPSG ID 6619)",                                                                  0 },	// SWEREF99
	{   6620L,  "Point58",                  "Point 58 (EPSG ID 6620)",                                                                  0 },	// Point 58
	{   6621L,  "FortMarigot",              "Fort Marigot (EPSG ID 6621)",                                                              0 },	// Fort Marigot
	{   6622L,  "StAnne",                   "Sainte Anne (EPSG ID 6622)",                                                               0 },	// Guadeloupe 1948
	{   6623L,  "CSG67",                    "Centre Spatial Guyanais 1967 (EPSG ID 6623)",                                              0 },	// Centre Spatial Guyanais 1967
	{   6624L,  "Guyane95",                 "Reseau Geodesique Francais Guyane 1995 (EPSG ID 6624)",                                    0 },	// Reseau Geodesique Francais Guyane 1995
	{   6625L,  "FortDesaix",               "Fort Desaix (EPSG ID 6625)",                                                               0 },	// Martinique 1938
	{   6626L,  "REUNION",                  "Piton des Neiges (EPSG ID 6626)",                                                          1 },	// Reunion 1947
	{   6627L,  "Reunion92",                "Reseau Geodesique de la Reunion 1992 (EPSG ID 6627)",                                      0 },	// Reseau Geodesique de la Reunion 1992
	{   6628L,  "Tahiti",                   "Tahiti (EPSG ID 6628)",                                                                    0 },	// Tahiti 52
	{   6629L,  "Tahaa",                    "Tahaa (EPSG ID 6629)",                                                                     0 },	// Tahaa 54
	{   6630L,  "IGN72/NH",                 "IGN72 Nuku Hiva (EPSG ID 6630)",                                                           0 },	// IGN72 Nuku Hiva
	{   6631L,  "K01949",                   "K0 1949 (EPSG ID 6631)",                                                                   2 },	// K0 1949
	{   6632L,  "Combani50",                "Combani 1950 (EPSG ID 6632)",                                                              0 },	// Combani 1950
	{   6633L,  "IGN56Lifou",               "IGN56 Lifou (EPSG ID 6633)",                                                               0 },	// IGN56 Lifou
	{   6634L,  "IGN72GrandeTerre",         "IGN72 Grande Terre (EPSG ID 6634)",                                                        0 },	// IGN72 Grande Terre
	{   6635L,  "ST87Ouvea",                "ST87 Ouvea (EPSG ID 6635)",                                                                2 },	// ST87 Ouvea
	{   6636L,  "Petrels72",                "Petrels 1972 (EPSG ID 6636)",                                                              0 },	// Petrels 1972
	{   6637L,  "Perroud50",                "Pointe Geologie Perroud 1950 (EPSG ID 6637)",                                              0 },	// Pointe Geologie Perroud 1950
	{   6638L,  "Miquelon50",               "Saint Pierre et Miquelon 1950 (EPSG ID 6638)",                                             0 },	// Saint Pierre et Miquelon 1950
	{   6639L,  "MOP78",                    "MOP78 (EPSG ID 6639)",                                                                     0 },	// MOP78
	{   6640L,  "Antilles91",               "Reseau de Reference des Antilles Francaises 1991 (EPSG ID 6640)",                          0 },	// Reseau de Reference des Antilles Francaises 1991
	{   6641L,  "IGN53/Mare",               "IGN53 Mare (EPSG ID 6641)",                                                                0 },	// IGN53 Mare
	{   6642L,  "ST84IleDesPins",           "ST84 Ile des Pins (EPSG ID 6642)",                                                         0 },	// ST84 Ile des Pins
	{   6643L,  "ST71Belep",                "ST71 Belep (EPSG ID 6643)",                                                                0 },	// ST71 Belep
	{   6644L,  "NEA74Noumea",              "NEA74 Noumea (EPSG ID 6644)",                                                              0 },	// NEA74 Noumea
	{   6645L,  "Caledonie91",              "Reseau Geodesique Nouvelle Caledonie 1991 (EPSG ID 6645)",                                 2 },	// Reseau Geodesique Nouvelle Caledonie 1991
	{   6657L,  "Reykjavik",                "Reykjavik 1900 (EPSG ID 6657)",                                                            1 },	// Reykjavik 1900
	{   6658L,  "HJORSEY",                  "Hjorsey 1955 (EPSG ID 6658)",                                                              1 },	// Hjorsey 1955
	{   6659L,  "ISN93",                    "Islands Network 1993 (EPSG ID 6659)",                                                      1 },	// Islands Network 1993
	{   6660L,  "Helle1954",                "Helle 1954 (EPSG ID 6660)",                                                                0 },	// Helle 1954
	{   6661L,  "Latvia1992",               "Latvia 1992 (EPSG ID 6661)",                                                               0 },	// Latvia 1992
	{   6663L,  "PortoSanto1995",           "Porto Santo 1995 (EPSG ID 6663)",                                                          0 },	// Porto Santo 1995
	{   6664L,  "AzoresEast95",             "Azores Oriental Islands 1995 (EPSG ID 6664)",                                              0 },	// Azores Oriental Islands 1995
	{   6665L,  "AzoresCntrl95",            "Azores Central Islands 1995 (EPSG ID 6665)",                                               0 },	// Azores Central Islands 1995
	{   6666L,  "Lisbon1890",               "Lisbon 1890 (EPSG ID 6666)",                                                               0 },	// Lisbon 1890
	{   6667L,  "IraqKuwait1992",           "Iraq-Kuwait Boundary Datum 1992 (EPSG ID 6667)",                                           0 },	// Iraq-Kuwait Boundary Datum 1992
	{   6670L,  "IGM1995",                  "Istituto Geografico Militaire 1995 (EPSG ID 6670)",                                        0 },	// Istituto Geografico Militaire 1995
	{      0L,  "",                         "",                                                                                         0 },	// End of table marker
};
struct csOracleElpMap_
{
	long epsgNbr;
	char msiName [24];
	char oracleName [96];
};
const struct csOracleElpMap_ csOracleElpMap [] =
{
	{   7001L,  "AIRY30",                 "Airy 1830 (EPSG ID 7001)"                       },	// Airy 1830
	{   7002L,  "AIRY-MOD",               "Airy Modified 1849 (EPSG ID 7002)"              },	// Airy Modified 1849
	{   7003L,  "ANS66",                  "Australian National Spheroid (EPSG ID 7003)"    },	// Australian National Spheroid
	{   7004L,  "BESSEL",                 "Bessel 1841 (EPSG ID 7004)"                     },	// Bessel 1841
	{   7005L,  "BESL-MOD",               "Bessel Modified (EPSG ID 7005)"                 },	// Bessel Modified
	{   7007L,  "CLRK58",                 "Clarke 1858 (EPSG ID 7007)"                     },	// Clarke 1858
	{   7008L,  "CLRK66",                 "Clarke 1866 (EPSG ID 7008)"                     },	// Clarke 1866
	{   7009L,  "MICHIGAN",               "Clarke 1866 Michigan (EPSG ID 7009)"            },	// Clarke 1866 Michigan
	{   7010L,  "CLRK-PAL",               "Clarke 1880 (Benoit) (EPSG ID 7010)"            },	// Clarke 1880 (Benoit)
	{   7011L,  "CLRK-IGN",               "Clarke 1880 (IGN) (EPSG ID 7011)"               },	// Clarke 1880 (IGN)
	{   7012L,  "CLRK-RGS",               "Clarke 1880 (RGS) (EPSG ID 7012)"               },	// Clarke 1880 (RGS)
	{   7013L,  "CLRK-ARC",               "Clarke 1880 (Arc) (EPSG ID 7013)"               },	// Clarke 1880 (Arc)
	{   7014L,  "CLRK22",                 "Clarke 1880 (SGA 1922) (EPSG ID 7014)"          },	// Clarke 1880 (SGA 1922)
	{   7015L,  "EVEREST",                "Everest 1830 (1937 Adjustment) (EPSG ID 7015)"  },	// Everest 1830 (1937 Adjustment)
	{   7016L,  "Everest1830/67",         "Everest 1830 (1967 Definition) (EPSG ID 7016)"  },	// Everest 1830 (1967 Definition)
	{   7018L,  "EVRST-MD",               "Everest 1830 Modified (EPSG ID 7018)"           },	// Everest 1830 Modified
	{   7019L,  "GRS1980",                "GRS 1980 (EPSG ID 7019)"                        },	// GRS 1980
	{   7020L,  "HLMRT06",                "Helmert 1906 (EPSG ID 7020)"                    },	// Helmert 1906
	{   7021L,  "IndonesianNtl",          "Indonesian National Spheroid (EPSG ID 7021)"    },	// Indonesian National Spheroid
	{   7022L,  "INTNL",                  "International 1924 (EPSG ID 7022)"              },	// International 1924
	{   7024L,  "KRASOV",                 "Krassowsky 1940 (EPSG ID 7024)"                 },	// Krassowsky 1940
	{   7025L,  "NWL-9D",                 "NWL 9D (EPSG ID 7025)"                          },	// NWL 9D
	{   7027L,  "PLESSIS",                "Plessis 1817 (EPSG ID 7027)"                    },	// Plessis 1817
	{   7028L,  "STRU1860",               "Struve 1860 (EPSG ID 7028)"                     },	// Struve 1860
	{   7029L,  "WAR-OFC",                "War Office (EPSG ID 7029)"                      },	// War Office
	{   7030L,  "WGS84",                  "WGS 84 (EPSG ID 7030)"                          },	// WGS 84
	{   7031L,  "GEM-10C",                "GEM 10C (EPSG ID 7031)"                         },	// GEM 10C
	{   7032L,  "OSU86F",                 "OSU86F (EPSG ID 7032)"                          },	// OSU86F
	{   7033L,  "OSU91A",                 "OSU91A (EPSG ID 7033)"                          },	// OSU91A
	{   7034L,  "Clrk80-Strasser",        "Clarke 1880 (EPSG ID 7034)"                     },	// Clarke 1880
	{   7035L,  "SPHERE-1",               "Sphere (EPSG ID 7035)"                          },	// Sphere
	{   7036L,  "GRS1967",                "GRS 1967 (EPSG ID 7036)"                        },	// GRS 1967
	{   7041L,  "ATS77",                  "Average Terrestrial System 1977 (EPSG ID 7041)" },	// Average Terrestrial System 1977
	{   7042L,  "Everest1830",            "Everest (1830 Definition) (EPSG ID 7042)"       },	// Everest (1830 Definition)
	{   7043L,  "WGS72",                  "WGS 72 (EPSG ID 7043)"                          },	// WGS 72
	{   7044L,  "Everest1830Def62",       "Everest 1830 (1962 Definition) (EPSG ID 7044)"  },	// Everest 1830 (1962 Definition)
	{   7045L,  "Everest1830Def75",       "Everest 1830 (1975 Definition) (EPSG ID 7045)"  },	// Everest 1830 (1975 Definition)
	{   7046L,  "BeslNmb-GLM",            "Bessel Namibia (GLM) (EPSG ID 7046)"            },	// Bessel Namibia (GLM)
	{   7049L,  "Xian80",                 "Xian 1980 (EPSG ID 7049)"                       },	// Xian 1980
	{   7050L,  "SA1969",                 "GRS 1967 (SAD69) (EPSG ID 7050)"                },	// GRS 1967 (SAD69)
	{   7051L,  "DANEMARK",               "Danish 1876 (EPSG ID 7051)"                     },	// Danish 1876
	{      0L,  "",                       ""                                              },	// End of table marker
};
long EXP_LVL1 CS_oracleNbr2Epsg (long oracleNbr,unsigned short* flags)
{
	long epsgNbr = -1;
	const struct csOracleNbrMap_ *tblPtr;
	
	if (flags != 0) *flags = 0;
	for (tblPtr = csOracleNbrMap;tblPtr->oracleNbr != 0;tblPtr += 1)
	{
		if (tblPtr->oracleNbr == oracleNbr)
		{
...
long EXP_LVL1 CS_epsgNbr2Oracle (long epsgNbr,unsigned short* flags)
{
	long oracleNbr = 0;
	const struct csOracleNbrMap_ *tblPtr;
...
Const char* EXP_LVL1 CS_oracleNbr2Name (long oracleNbr)
{
	Const char* oracleNamePtr = 0;
	const struct csOracleNbrMap_ *tblPtr;
	...
	for (tblPtr = csOracleNbrMap;tblPtr->oracleNbr != 0;tblPtr += 1)
	{
		if (tblPtr->oracleNbr == oracleNbr)
		{
			oracleNamePtr = tblPtr->oracleName;
		}
	}
	return oracleNamePtr;
}
long EXP_LVL1 CS_oracleName2Nbr (Const char* oracleName)
{
	long oracleNbr = -1;
	const struct csOracleNbrMap_ *tblPtr;
	...
	for (tblPtr = csOracleNbrMap;tblPtr->oracleNbr != 0;tblPtr += 1)
	{
		if (!CS_stricmp (tblPtr->oracleName,oracleName))
		{
			oracleNbr = tblPtr->oracleNbr;
			break;
		}
...
const char* EXP_LVL1 CS_msiName2Oracle (Const char* msiName)
{
	...
	epsgNbr = CSmsi2EpsgCS (msiName,&myFlags);
	if (epsgNbr != 0)
	{
		oracleNbr = CS_epsgNbr2Oracle (epsgNbr,&myFlags);
		if (oracleNbr != 0)
		{
			oracleNamePtr = CS_oracleNbr2Name (oracleNbr);
		}
	}
	return oracleNamePtr;
}
long EXP_LVL1 CS_oracleName2Epsg (Const char* oracleName)
{
	long epsgNbr = -1;
	const struct csOracleNbrMap_ *tblPtr;
...
const char* EXP_LVL1 CS_oracleName2Msi (Const char* oracleName)
{
	...
	epsgNbr = CS_oracleName2Epsg (oracleName);
	if (epsgNbr > 0)
	{
		msiNamePtr = CSepsg2msiCS (epsgNbr,&myFlags);
	}
	return msiNamePtr;
}
Const char* EXP_LVL1 CS_oracleNameByIdx (unsigned short index,unsigned short* flags)
{
	Const char* oracleName = 0;
	const unsigned short idxMax = sizeof (csOracleNbrMap) / sizeof (struct csOracleNbrMap_);

	if (flags != 0) *flags = 0;
	if (index < idxMax)
	{
		oracleName = csOracleNbrMap [index].oracleName;
		if (flags != 0) *flags = csOracleNbrMap [index].flags;
	}
	return oracleName;
}
long EXP_LVL1 CS_oracleNbrByIdx (unsigned short index,unsigned short* flags)
{
	long oracleNbr = 0;
	const unsigned short idxMax = sizeof (csOracleNbrMap) / sizeof (struct csOracleNbrMap_);
	...
	if (index < idxMax)
	{
		oracleNbr = csOracleNbrMap [index].oracleNbr;
		if (flags != 0) *flags = csOracleNbrMap [index].flags;
	}
	return oracleNbr;
}
long EXP_LVL1 CS_oracleDtmName2EpsgNbr (Const char* oracleName,unsigned short* flags)
{
	long epsgNbr = -1;
	const struct csOracleDtmMap_ *tblPtr;

	if (flags != 0) *flags = 0;
	for (tblPtr = csOracleDtmMap;tblPtr->oracleName [0] != '\0';tblPtr += 1)
	{
		if (!CS_stricmp (tblPtr->oracleName,oracleName))
		{
			epsgNbr = tblPtr->epsgNbr;
...
Const char* EXP_LVL1 CS_epsgDtmNbr2OracleName (long epsgNbr,unsigned short* flags)
{
	Const char* oracleName = 0;
	const struct csOracleDtmMap_ *tblPtr;
...
{
	Const char* oracleDtmName = 0;
	const unsigned short idxMax = sizeof (csOracleDtmMap) / sizeof (struct csOracleDtmMap_);

	if (flags != 0) *flags = 0;
	if (index < idxMax)
	{
		oracleDtmName = csOracleDtmMap [index].oracleName;
		if (flags != 0) *flags = csOracleDtmMap [index].flags;
	}
	return oracleDtmName;
}
long EXP_LVL1 CS_oracleElpName2Epsg (Const char* oracleName)
{
	long epsgNbr = -1;
	const struct csOracleElpMap_ *tblPtr;

	for (tblPtr = csOracleElpMap;tblPtr->oracleName [0] != '\0';tblPtr += 1)
	{
		if (!CS_stricmp (tblPtr->oracleName,oracleName))
		{
			epsgNbr = tblPtr->epsgNbr;
