/******************************************************************************
	...
	*********************************************************************  
			 ...
			 File Name: $Source: C:/Development/NewCsMap/rcs/CS_dtAgd66ToGda94.c $
			 Full Name:	AGD66 to GDA94 Compund Object
		   Description:
			   Purpose:	Combines multiple Autralian datum shift
						data files into a single object so that the
						AGD66 to GDA94 conversion looks like a single
						object.

		Revision Level:	$Revision: #4 $
				  Date:	$Date: 2006/11/16 $

		 Last Revision:	$Log: CS_dtAgd66ToGda94.c $
		 ...
		 Last Revision:	Revision 10.201  2000/04/03 21:34:39  nto
		 ...
		 Last Revision:	Revision 1.1  1999/10/16 22:03:46  nto
