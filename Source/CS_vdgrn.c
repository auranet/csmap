/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.401  2000/10/27 03:58:48  nto
		Last Revision:	Fixed a bug with the false origin.  Never worked before if x_off or y_off
		Last Revision:	were not zero.
		...
		Last Revision:	Revision 10.1  2000/01/31 00:09:19  nto
		...
		Last Revision:	Revision 1.2  1999/09/06 16:44:20  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_vdgrn.c#3 $"};
#endif
...
int EXP_LVL9 CSvdgrnI (Const struct cs_Vdgrn_ *vdgrn,double ll [2],Const double xy [2])
{
	...
	/* Compute the latitude.  The ((3 * dd) / (a1 * m1))
	   term goes to hell when Y is zero.  Since Y == 0 means
