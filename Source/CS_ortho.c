/******************************************************************************
	...
	*********************************************************************  
		...
		Last Revision:	Revision 10.1  2000/01/30 23:59:15  nto
		Last Revision:	Removed == comparisions of doubles.  Also some PCLint clean up.
		Last Revision:	Revision 10.0  1999/10/05 18:27:17  nto
		Last Revision:	Revision 9.99  1999/10/05 17:36:28  nto
		Last Revision:	Revision 1.2  1999/09/05 19:13:40  nto
		Last Revision:	This revision compiles, links, and generates a successful test program.

******************************************************************************/

#ifdef LABEL_MODULE
static char revlvl [] = {"$Id: //depot/Libraries/CsMap/current/src/CS_ortho.c#3 $"};
#endif
